import { Lock, FileText, Users, Phone, Heart, Shield, MapPin, Globe } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="p-4 text-center shadow-medium">
          ...
          <h3 className="font-semibold text-sm mb-1">Digital Reports</h3>
          <p className="text-xs text-muted-foreground">
        ...
        <Card className="p-4 text-center shadow-medium">
          ...
          <h3 className="font-semibold text-sm mb-1">Connect with Help</h3>
          <p className="text-xs text-muted-foreground">
      ...
      <h3 className="text-xl font-semibold text-center">Emergency Resources</h3>
        ...
        <Card className="p-5 shadow-medium hover:shadow-strong transition-smooth">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  <strong className="text-xs">Emergency Services:</strong>
                  <p className="text-primary text-sm">112 or 999 (Kenya)</p>
                </div>
                <div>
                  <strong className="text-xs">Crisis Text Line:</strong>
      ...
      <Card className="p-4 bg-muted/50 border-2 border-primary/20">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              All resources are verified organizations. If you're in immediate danger, 
              call emergency services (112 in Kenya, 999 in many African countries).
            </p>
          </div>
        </div>
      </Card>
